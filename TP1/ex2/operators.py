...
def miss_l_to_right(state):
    if state.number_cannibals_left() - 1 >= state.number_cannibals_left() and state.boat_position == "left":
        print("miss_l_to_right")
        return State(state.number_miss_right + 1, state.number_cannibals_right, "right")


def cann_l_to_right(state):
    if state.number_miss_right >= state.number_cannibals_right + 1 and state.boat_position == "left":
...
def miss_miss_l_to_right(state):
    if state.number_miss_left() - 2 >= state.number_cannibals_left() and state.boat_position == "left":
...
def cann_cann_l_to_right(state):
    if state.number_miss_right >= state.number_cannibals_right + 2 and state.boat_position == "left":
...
def cann_r_to_left(state):
    if state.number_miss_left() >= state.number_cannibals_left() + 1 and state.boat_position == "right":
...
def miss_miss_r_to_left(state):
    if state.number_miss_right - 2 >= state.number_cannibals_right and state.boat_position == "right":
...
def miss_r_to_left(state):
    if state.number_miss_right - 1 >= state.number_cannibals_right and state.boat_position == "right":
...
def cann_cann_r_to_left(state):
    if state.number_miss_left() >= state.number_cannibals_left() + 2 and state.boat_position == "right":
